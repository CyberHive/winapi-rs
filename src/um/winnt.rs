...
pub const WOW64_CONTEXT_FULL: DWORD =
    WOW64_CONTEXT_CONTROL | WOW64_CONTEXT_INTEGER | WOW64_CONTEXT_SEGMENTS;
pub const WOW64_CONTEXT_ALL: DWORD = WOW64_CONTEXT_CONTROL
...
pub const SECURITY_MAX_SID_STRING_CHARACTERS: BYTE =
...
pub const SYSTEM_LUID: LUID = LUID {
    LowPart: 0x3e7,
    HighPart: 0x0,
};
pub const ANONYMOUS_LOGON_LUID: LUID = LUID {
    LowPart: 0x3e6,
    HighPart: 0x0,
};
pub const LOCALSERVICE_LUID: LUID = LUID {
    LowPart: 0x3e5,
    HighPart: 0x0,
};
pub const NETWORKSERVICE_LUID: LUID = LUID {
    LowPart: 0x3e4,
    HighPart: 0x0,
};
pub const IUSER_LUID: LUID = LUID {
    LowPart: 0x3e3,
    HighPart: 0x0,
};
...
pub const SE_GROUP_VALID_ATTRIBUTES: DWORD = SE_GROUP_MANDATORY
...
pub const TOKEN_TRUST_CONSTRAINT_MASK: DWORD =
...
pub const TOKEN_MANDATORY_POLICY_VALID_MASK: DWORD =
...
pub const JOB_OBJECT_VALID_COMPLETION_FILTER: DWORD =
    ((1 << (JOB_OBJECT_MSG_MAXIMUM + 1)) - 1) - ((1 << JOB_OBJECT_MSG_MINIMUM) - 1);
...
pub const XSTATE_MASK_AVX512: ULONG64 =
...
pub const XSTATE_MASK_ALLOWED: ULONG64 = XSTATE_MASK_LEGACY
    | XSTATE_MASK_AVX
    | XSTATE_MASK_MPX
    | XSTATE_MASK_AVX512
    | XSTATE_MASK_IPT
...
pub const XSTATE_CONTROLFLAG_VALID_MASK: ULONG64 =
...
pub const SECTION_ALL_ACCESS: DWORD = STANDARD_RIGHTS_REQUIRED
    | SECTION_QUERY
    | SECTION_MAP_WRITE
    | SECTION_MAP_READ
    | SECTION_MAP_EXECUTE
...
pub const SESSION_ALL_ACCESS: DWORD =
...
pub const MEMORY_PARTITION_ALL_ACCESS: DWORD = STANDARD_RIGHTS_REQUIRED
    | SYNCHRONIZE
...
pub const SEF_MACL_VALID_FLAGS: ULONG =
...
extern "system" {
    pub fn RtlCrc32(Buffer: *const c_void, Size: size_t, InitialCrc: DWORD) -> DWORD;
    pub fn RtlCrc64(Buffer: *const c_void, Size: size_t, InitialCrc: ULONGLONG) -> ULONGLONG;
}
...
pub const RTL_CONDITION_VARIABLE_INIT: RTL_CONDITION_VARIABLE =
    RTL_CONDITION_VARIABLE { Ptr: 0 as PVOID };
...
pub const REG_LEGAL_OPTION: DWORD = REG_OPTION_RESERVED
...
pub const REG_OPEN_LEGAL_OPTION: DWORD = REG_OPTION_RESERVED
    | REG_OPTION_BACKUP_RESTORE
    | REG_OPTION_OPEN_LINK
    | REG_OPTION_DONT_VIRTUALIZE;
...
pub const SERVICE_DRIVER: DWORD =
...
pub const SERVICE_TYPE_ALL: DWORD = SERVICE_WIN32
    | SERVICE_ADAPTER
    | SERVICE_DRIVER
...
pub const TRANSACTIONMANAGER_GENERIC_READ: DWORD =
...
pub const TRANSACTION_GENERIC_READ: DWORD =
    STANDARD_RIGHTS_READ | TRANSACTION_QUERY_INFORMATION | SYNCHRONIZE;
pub const TRANSACTION_GENERIC_WRITE: DWORD = STANDARD_RIGHTS_WRITE
    ...
    | SYNCHRONIZE;
pub const TRANSACTION_GENERIC_EXECUTE: DWORD =
    STANDARD_RIGHTS_EXECUTE | TRANSACTION_COMMIT | TRANSACTION_ROLLBACK | SYNCHRONIZE;
pub const TRANSACTION_ALL_ACCESS: DWORD = STANDARD_RIGHTS_REQUIRED
...
pub const RESOURCEMANAGER_GENERIC_READ: DWORD =
...
pub const ENLISTMENT_GENERIC_WRITE: DWORD = STANDARD_RIGHTS_WRITE
    | ENLISTMENT_SET_INFORMATION
    | ENLISTMENT_RECOVER
    | ENLISTMENT_SUBORDINATE_RIGHTS
    | ENLISTMENT_SUPERIOR_RIGHTS;
pub const ENLISTMENT_GENERIC_EXECUTE: DWORD = STANDARD_RIGHTS_EXECUTE
    | ENLISTMENT_RECOVER
    | ENLISTMENT_SUBORDINATE_RIGHTS
    | ENLISTMENT_SUPERIOR_RIGHTS;
pub const ENLISTMENT_ALL_ACCESS: DWORD = STANDARD_RIGHTS_REQUIRED
